<template>
  <div class="login-container">
    <img
      class="logo-top-right-global"
      src="src/assets/PayFlowS.jpg"
      alt="PayFlow Logo"
    />
      ...
      <div class="login-content">
        <q-card class="login-form" flat bordered>
          ...
          <div class="extra-links">
            <q-btn flat dense label="Registrarse" class="text-white" color="primary" />
            <q-btn flat dense label="Olvidé mi contraseña" class="text-white" color="primary"/>
